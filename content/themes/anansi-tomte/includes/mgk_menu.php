...
add_filter( 'wp_setup_nav_menu_item', 'magikPvc_add_custom_fields' );

function magikPvc_add_custom_fields( $menu_item ) {
...
add_action( 'wp_update_nav_menu_item', 'magikPvc_update_custom_fields', 10, 3 );

function magikPvc_update_custom_fields( $menu_id, $menu_item_db_id, $args ) {
...
// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'magikPvc_menu_edit_walker', 10, 2 );

function magikPvc_menu_edit_walker($walker = '', $menu_id = '') {
    return 'magikPvc_Walker_Nav_Menu_Edit';
}

// Create HTML list of nav menu input items.
// Extend from Walker_Nav_Menu class
class magikPvc_Walker_Nav_Menu_Edit extends Walker_Nav_Menu  {
    /**
            ...
            <span class="item-controls">
                ...
                <span class="item-order hide-if-js">
                    <a href="<?php
                        ...
                        ?>" class="item-move-up"><abbr title="<?php esc_attr_e( 'Move up','pvc');?>">&#8593;</abbr></a>
                    |
                    <a href="<?php
                        echo wp_nonce_url(
                            esc_url( add_query_arg(
                        ...
                        ?>" class="item-move-down"><abbr title="<?php esc_attr_e( 'Move down','pvc');?>">&#8595;</abbr></a>
                </span>
                <a class="item-edit" id="edit-<?php echo esc_html($item_id); ?>" title="<?php esc_attr_e('Edit Menu Item','pvc');?>" href="<?php
                    ...
                    ?>"><?php esc_attr_e( 'Edit Menu Item','pvc'); ?></a>
            </span>
        </dt>
    </dl>
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-title-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Navigation Label','pvc'); ?><br />
    ...
    <p class="description">
        <label for="edit-menu-item-target-<?php echo esc_html($item_id); ?>">
            ...
            <?php esc_attr_e( 'Open link in a new window/tab','pvc'); ?>
        </label>
    </p>
    <?php
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-icon-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Font Awesome Icon Class','pvc'); ?><br />
            ...
            <span><?php echo esc_html__('Input font awesome icon or icon class. You can see', 'pvc').' <a target="_blank" href="http://fortawesome.github.io/Font-Awesome/icons/">'.esc_html__('Font Awesome Icons in here', 'pvc').'</a>.' ?></span>
        </label>
    </p>
    <p class="description">
    ...
    <p class="description">
        <label for="edit-menu-item-hide-<?php echo esc_html($item_id); ?>">
            ...
            <?php esc_attr_e( "Don't show a link",'pvc'); ?>
        </label>
    </p>
    <p class="description">
        <label for="edit-menu-item-mobile_hide-<?php echo esc_html($item_id); ?>">
            ...
            <?php esc_attr_e( "Don't show a link on mobile panel",'pvc'); ?>
        </label>
    </p>
    <div class="menu-item-level0-<?php echo esc_html($item_id); ?>" style="<?php if ($depth == 0) echo 'display:block;'; else echo 'display:none;' ?>">
        ...
        <p class="description description-thin description-thin-custom">
            <label for="edit-menu-item-type-menu-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Menu Type','pvc'); ?><br />
                <select id="edit-menu-item-type-menu-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_type) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e('Narrow','pvc'); ?></option>
                    <option value="wide" <?php if(esc_html($item->popup_type) == "wide"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Wide','pvc'); ?></option>
                </select>
            </label>
        </p>
        <p class="description description-thin description-thin-custom">
            <label for="edit-menu-item-popup_pos-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Popup Position','pvc'); ?><br />
                ...
                >
                    <option value="pos-left" <?php if(esc_html($item->popup_pos) == "pos-left"){echo 'selected="selected"';} ?>><?php esc_attr_e('Left','pvc') ?></option>
                    <option value="pos-right" <?php if(esc_html($item->popup_pos) == "pos-right"){echo 'selected="selected"';} ?>><?php esc_attr_e('Right','pvc') ?></option>
                    <option value="" <?php if(esc_html($item->popup_pos) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e('Justify (only for wide)','pvc') ?></option>
                    <option value="pos-center" <?php if(esc_html($item->popup_pos) == "pos-center"){echo 'selected="selected"';} ?>><?php esc_attr_e('Center (only for wide)','pvc') ?></option>
                </select>
            </label>
        </p>
        <div style="clear:both;"></div>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_cols-<?php echo esc_html($item_id); ?>">
                <br/><?php esc_attr_e( 'Popup Columns (only for wide)','pvc'); ?><br />
                <select id="edit-menu-item-popup_cols-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_cols) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Select','pvc'); ?></option>
                    <option value="col-2" <?php if(esc_html($item->popup_cols) == "col-2"){echo 'selected="selected"';} ?>><?php esc_attr_e( '2 Columns','pvc'); ?></option>
                    <option value="col-3" <?php if(esc_html($item->popup_cols) == "col-3"){echo 'selected="selected"';} ?>><?php esc_attr_e( '3 Columns','pvc'); ?></option>
                    <option value="col-4" <?php if(esc_html($item->popup_cols) == "col-4"){echo 'selected="selected"';} ?>><?php esc_attr_e( '4 Columns','pvc'); ?></option>
                    <option value="col-5" <?php if(esc_html($item->popup_cols) == "col-5"){echo 'selected="selected"';} ?>><?php esc_attr_e( '5 Columns','pvc'); ?></option>
                    <option value="col-6" <?php if(esc_html($item->popup_cols) == "col-6"){echo 'selected="selected"';} ?>><?php esc_attr_e( '6 Columns','pvc'); ?></option>
                </select>
            </label>
        </p>
    ...
    <div class="menu-item-level1-<?php echo esc_html($item_id); ?>" style="<?php if ($depth == 1) echo 'display:block;'; else echo 'display:none;' ?>">
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-cols-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Columns (only for wide)','pvc'); ?><br />
                ...
                <span class="description"><?php esc_attr_e('will occupy x columns of parent popup columns','pvc'); ?></span>
            </label>
        </p>
    ...
    <div class="menu-item-level2-<?php echo esc_html($item_id); ?>" style="<?php if ($depth == 0 || $depth == 1) echo 'display:block;'; else echo 'display:none;' ?>">
        <p class="description description-wide">
            <label for="edit-menu-item-popup_bg_image-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Background Image (only for wide)','pvc'); ?><br />
                ...
                <br/>
                <input class="button_upload_image button" id="edit-menu-item-popup_bg_image-<?php echo esc_html($item_id); ?>" type="button" value="<?php esc_attr_e('Upload Image','pvc');?>" />&nbsp;
                <input class="button_remove_image button" id="edit-menu-item-popup_bg_image-<?php echo esc_html($item_id); ?>" type="button" value="<?php esc_attr_e('Remove Image','pvc');?>" />
            </label>
        </p>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_bg_pos-<?php echo esc_html($item_id); ?>">
                <br/><?php esc_attr_e( 'Background Position (only for wide)','pvc'); ?><br />
                <select id="edit-menu-item-popup_bg_pos-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_bg_pos) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e('Select','pvc'); ?></option>
                    <option value="left top" <?php if(esc_html($item->popup_bg_pos) == "left top"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Left Top','pvc'); ?></option>
                    <option value="left center" <?php if(esc_html($item->popup_bg_pos) == "left center"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Left Center','pvc'); ?></option>
                    <option value="left center" <?php if(esc_html($item->popup_bg_pos) == "left center"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Left Center','pvc'); ?></option>
                    <option value="left bottom" <?php if(esc_html($item->popup_bg_pos) == "left bottom"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Left Bottom','pvc'); ?></option>
                    <option value="center top" <?php if(esc_html($item->popup_bg_pos) == "center top"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Center Top','pvc'); ?></option>
                    <option value="center center" <?php if(esc_html($item->popup_bg_pos) == "center center"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Center Center','pvc'); ?></option>
                    <option value="center bottom" <?php if(esc_html($item->popup_bg_pos) == "center bottom"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Center Bottom','pvc'); ?></option>
                    <option value="right top" <?php if(esc_html($item->popup_bg_pos) == "right top"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Right Top','pvc'); ?></option>
                    <option value="right center" <?php if(esc_html($item->popup_bg_pos) == "right center"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Right Center','pvc'); ?></option>
                    <option value="right bottom" <?php if(esc_html($item->popup_bg_pos) == "right bottom"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Right Bottom','pvc'); ?></option>
                    );
                </select>
            </label>
        </p>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_bg_repeat-<?php echo esc_html($item_id); ?>">
                <br/><?php esc_attr_e( 'Background Repeat (only for wide)','pvc'); ?><br />
                <select id="edit-menu-item-popup_bg_repeat-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_bg_repeat) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Select','pvc'); ?></option>
                    <option value="no-repeat" <?php if(esc_html($item->popup_bg_repeat) == "no-repeat"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'No Repeat','pvc'); ?></option>
                    <option value="repeat" <?php if(esc_html($item->popup_bg_repeat) == "repeat"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Repeat All','pvc'); ?></option>
                    <option value="repeat-x" <?php if(esc_html($item->popup_bg_repeat) == "repeat-x"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Repeat Horizontally','pvc'); ?></option>
                    <option value="repeat-y" <?php if(esc_html($item->popup_bg_repeat) == "repeat-y"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Repeat Vertically','pvc'); ?></option>
                    <option value="inherit" <?php if(esc_html($item->popup_bg_repeat) == "inherit"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Inherit','pvc'); ?></option>
                </select>
            </label>
        </p>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_bg_size-<?php echo esc_html($item_id); ?>">
                <br/><?php esc_attr_e( 'Background Size (only for wide)','pvc'); ?><br />
                <select id="edit-menu-item-popup_bg_size-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_bg_size) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Select','pvc'); ?></option>
                    <option value="inherit" <?php if(esc_html($item->popup_bg_size) == "inherit"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Inherit','pvc'); ?></option>
                    <option value="cover" <?php if(esc_html($item->popup_bg_size) == "cover"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Cover','pvc'); ?></option>
                    <option value="contain" <?php if(esc_html($item->popup_bg_size) == "contain"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Contain','pvc'); ?></option>
                </select>
            </label>
        </p>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_style-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Custom Styles (only for wide)','pvc'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-tip_label-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Tip Label','pvc'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-tip_color-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Tip Text Color','pvc'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-tip_bg-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Tip BG Color','pvc'); ?><br />
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-attr-title-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Title Attribute','pvc'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-classes-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'CSS Classes (optional)','pvc'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-xfn-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Link Relationship (XFN)','pvc'); ?><br />
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-description-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Description','pvc'); ?><br />
            ...
            <span class="description"><?php esc_attr_e( 'The description will be displayed in the menu if the current theme supports it.','pvc');  ?></span>
        </label>
    </p>
    <div class="menu-item-actions description-wide submitbox">
        ...
        <a class="item-delete submitdelete deletion" id="delete-<?php echo esc_html($item_id); ?>" href="<?php
            ...
            ); ?>"><?php esc_attr_e( 'Remove','pvc'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_html($item_id); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), esc_url( remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) ) );
        ?>#menu-item-settings-<?php echo esc_html($item_id); ?>"><?php esc_attr_e( 'Cancel','pvc'); ?></a>
    </div>
...
/* Top Navigation Menu */
if (!class_exists('MagikPvc_top_navwalker')) {
    class MagikPvc_top_navwalker extends Walker_Nav_Menu {
        ...
        function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ($depth == 1) {
                ...
                $output .= $indent . '<li id="nav-menu-item-'. esc_html($item->ID) . '" class="' . $class_names . ' ' . $active . $sub . $menu_type . $popup_pos . $popup_cols . strtolower(str_replace(' ', '-', str_replace('#038;', '-', $item->title))) . '" data-cols="'.$cols.'"'.$sub_popup_style.'>';
            } else {
                $output .= $indent . '<li id="nav-menu-item-'. esc_html($item->ID) . '" class="' . $class_names . ' ' . $active . $sub . $menu_type . $popup_pos . $popup_cols . strtolower(str_replace(' ', '-', str_replace('#038;', '-', $item->title))) . '">';
            }
...
/* Mobile Menu */
if (!class_exists('MagikPvc_mobile_navwalker')) {
    class MagikPvc_mobile_navwalker extends Walker_Nav_Menu {
...
/* Mobile Menu */
if (!class_exists('MagikPvc_home_mobile_navwalker')) {
        class MagikPvc_home_mobile_navwalker extends Walker_Nav_Menu {
        ...
        function start_lvl( &$output, $depth = 0, $args = array() ) {
            ...
            if ( $depth == 0 ) {
                $out_div = '<div class="mgk-popup wrap-popup"><div class="inner popup" style="'.$args->popup_style.'">';
            } else {
                $out_div = '';
            }
            $output .= "\n$indent$out_div<ul class=\"nav sub-menu\">\n";
        }
