...
//      'priority' => 1000,
//      'theme_supports' => '',
//      'title' => __( 'Mobile Menu Settings', 'weblogiqpress' ),
//      'description' => __( 'Controls the mobile menu', 'weblogiqpress' ),
//    ) );

//    // Create custom field for mobile navigation layout
//    $wp_customize->add_section( 'mobile_menu_layout' , array(
//        'title'	=> __('Mobile navigation layout','weblogiqpress'),
...
//        array(
//            'default'	=> __( 'topbar', 'weblogiqpress' ),
//        )
//    );
