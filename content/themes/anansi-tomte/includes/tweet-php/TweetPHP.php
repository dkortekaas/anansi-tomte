 ...
 class TweetPHP {
    ...
    public function  __construct ($options = array()) {
      ...
      array(
          ...
          'date_lang'             => 'nl-NL', // Language for date e.g. 'fr_FR'. See: http://php.net/manual/en/function.setlocale.php
...
$this->fetch_tweets();
    ...
    private function parse_tweet ($tweet) {
      ...
      return $this->options['tweet_wrap_open'] . $tweet_text . $this->options['meta_wrap_open'] . '<a href="' . $href . '" rel="nofollow" target="_blank">' . $display_time . '</a>' . $this->options['meta_wrap_close'] . $this->options['tweet_wrap_close'];
    }
