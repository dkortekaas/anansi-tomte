 ...
 * @since WeblogiqPress 1.1.0
 */

if ( ! class_exists( 'Weblogiqpress_protocol_relative_theme_assets' ) ) :
	class Weblogiqpress_protocol_relative_theme_assets {
		/**
	...
	$weblogiqpress_protocol_relative_theme_assets = new Weblogiqpress_protocol_relative_theme_assets;
endif;
