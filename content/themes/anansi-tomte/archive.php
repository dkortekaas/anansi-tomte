                ...
                if (is_tax('service_type')) :
                    ...
                    foreach ( $last_parent_cat as $last_parent_cat_value ) :
                        if( $term = get_term_by( 'id', $last_parent_cat_value, 'service_type' ) ) :
                            ...
                            if (isset($metaArray)) :
                                $serviceCatMetaTitle = $metaArray['wl_subtitle'];
                                echo '<h2 class="title-un">Anansi &amp; Tomte ' . $serviceCatMetaTitle . '</h2>';
                            else :
            ...
            <?php
                ...
                if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) :
                    ...
                    foreach ( $terms as $term ) :
                        ...
                        echo '<li class="cat-item cat-item-'.$term->term_id.' cat-parent"><a href="' . get_category_link( $term->term_id ) . '" title="' . $term->name . '">' . $term->name . '</a>';
                                    ...
                                    <div class="product-preview">
                                        <div class="preview">
                                            ...
                                            <?php
                                                ...
                                                if ( $serv_img[0] ) : ?>
                                                    <img src="<?php echo $serv_img[0]; ?>" alt="<?php the_title(); ?>" width="300" class="woocommerce-placeholder wp-post-image" height="300">
                                                <?php else : ?>
                                                    <img src="https://www.anansi-tomte.nl/wp-content/plugins/woocommerce/assets/images/placeholder.png" alt="<?php the_title(); ?>" width="300" class="woocommerce-placeholder wp-post-image" height="300">
                                                <?php endif;
                                            ?>
                                            </a>
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="content_price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                                ...
                                                <span class="woocommerce-Price-amount amount">
                                                    <span class="woocommerce-Price-currencySymbol">&euro;</span> <?php echo get_field('price_from'); ?>
