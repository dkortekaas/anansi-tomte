...
<div class="woocommerce-billing-fields ">
    <?php if (WC()->cart->ship_to_billing_address_only() && WC()->cart->needs_shipping()) : ?>
        ...
        <div class="step-title"><h3 class="one_page_heading"><?php _e('Billing &amp; Shipping', 'woocommerce'); ?>
            </h3></div>

    <?php else : ?>

        <div class="step-title"><h3 class="one_page_heading"><?php _e('Billing Details', 'woocommerce'); ?></h3>
        </div>
    <?php endif; ?>
