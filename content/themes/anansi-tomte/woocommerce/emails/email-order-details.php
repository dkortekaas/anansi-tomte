...
<table class="td" id="order-details" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Comic Sans MS', Segoe, cursive, sans-serif;" border="1">
	<thead>
		<tr>
				...
				foreach ( $totals as $total ) {
					...
					?><tr>
						...
						<td class="td" style="text-align:left; <?php if ( $i === 1 ) echo 'border-top-width: 4px;'; ?>">
							<?php echo str_replace('(', '<br/>(', $total['value']); ?>
						</td>
					</tr><?php
				}
			}
