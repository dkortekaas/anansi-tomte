...
<div class="content-main">
    <div class="row row-eq-height">
            ...
            <?php
                ...
                while ( $query->have_posts() ) { 
                    ...
                    foreach ( $categories as $key=>$category ) {
                        ...
                        $b = '<a class="category" href="' . get_category_link( $category ) . '">' . $category->name . '</a>';    
      ...
      <div class="<?php echo $colclass; ?>">
          <div class="colored bordered marbot">
              <div class="row">
                  <div class="col-xs-12">
              ...
              <?php endif; ?>
              <h2 class="page-title"><?php _e('Blog', 'anansi-tomte'); ?></h2>
              <?php if( $posts ) : ?>
                ...
                <article  id="post-<?php echo esc_html($post->ID); ?>" <?php post_class(); ?>>
                  <div class="post-container">
                    ...
                    <?php $imgoverview = get_field('overview_image'); ?>
        ...
        <?php if ( $sideleft ) : ?>
          <div class="col-sm-3 visible-xs clear">
            <div class="colored bordered">      
              <div class="product-categories">
              <h4 class="block-title"><?php _e('Categories', 'anansi-tomte'); ?></h4>
              <?php
